...
export const DEFAULT_FRICTION_AIR = 0.008 // matter js default = 0.01
export const DEFAULT_FRICTION_STATIC = 0.5 // matter js default = 0.5
export const DEFAULT_SLOP = 0 // matter js default = 0.05
export const DEFAULT_RESTITUTION = 0 // matter js default = 0
...
export const THUMBNAIL_KEYCODES = [
